...
import { Database, RefreshCw, Download, Upload, ArrowLeft } from 'lucide-react';
...
export default function WebStoreWebdataSection({config, updateConfig, fetchFirestoreProducts, fetchFirestoreCategories, handleImportCategory, cabangList, handleExport, handleImport, newCategoryName, setNewCategoryName, newCategoryIcon, setNewCategoryIcon}: Props) {
  return (
